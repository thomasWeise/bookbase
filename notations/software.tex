...
sort={Bash},%
description={%
is a shell used under \ubuntu\ \linux, i.e., the program that \inQuotes{runs} in the \gls{terminal} and interprets your commands, allowing you to start and interact with other programs~\cite{NR2005LTBSUSPCB3,Z2017MB,BN2018BC}. %
...
sort={Linux},%
description={%
is the leading open source operating system, i.e., a free alternative to \microsoftWindows~\cite{T1999TLE,B2022ELATCL,H2022LML,SFLR2009LIAN,VV2022LF}. %
...
description={%
is a \pgls{dbms} that can work on stand-alone files but also connect to other popular \pglspl{rdb}~\cite{FNFHWSKLSSGLFRSRPLJG2022BG7R1BOL7C,S2022L7PFEUU}.
...
sort={macOS},%
description={%
or Mac~OS is the operating system that powers Apple Mac(intosh) computers~\cite{S2025MAPAMAIE2,RRJ2008MFUG}. %
...
text={\softwareStyle{MacPorts}},%
name={MacPorts},%
sort={MacPorts},%
description={%
is an abstraction layer that allows you to compile, install, upgrade, and use \pgls{OSS} software, often from the \linux\ realm, on \pgls{macOS}~\cite{RRJ2008MFUG}.
As such, it is a bit similar to \pgls{MSYS2}, which is for \microsoftWindows. %
Learn more at \url{https://www.macports.org}.%
}%
}%
%
%
...
description={%
is a \pgls{dbms} that can work on \pglspl{db} stored in single, stand-alone files but also connect to other popular \pglspl{rdb}~\cite{SSI2023MA2BTA,B2020HOMA2,UC2021AFD,MM2014RDAMA}. %
...
It has been used in several different research works, including~\cite{TOvdBLW2024ESTAEFFFA,ZLWvdBTW2024RLSOT2RBPPWIR,ZWvdBTLTW2024RLSFTDBPAANRFFFA,LWLvdBTW2024ATTSPWFFAAHA,LWLvdBW2022STTSPUFFA,LWTWW2024GSIWIFFTTSP,CWTW2024FFAOWBFGSORLSOTQAP,XWvdBW2024RLSVNVFFAOTTTP}. %
Algorithms implemented by \moptipy\ include \glspl{algoEA}, \gls{algoEAopo}, \gls{algoRLS}, \gls{algoSA}, and the \gls{algoFEAopo}, amongst others. %
Learn more at \url{https://thomasweise.github.io/moptipy} and \url{https://thomasweise.github.io/moptipyapps}.%
}%
}%
...
It is a bit similar to \pgls{macPorts}, which is for \pgls{macOS}. %
...
It comes in a free edition, so it can be downloaded and used at no cost. %
...
text={\softwareStyle{Xcode}},%
name={Xcode},%
sort={Xcode},%
description={%
is offers the tools for developing, \glslink{unitTest}{testing}, and distributing applications as well as an \pgls{ide} for Apple platforms such as \pgls{macOS} and \pgls{appleIOS}~\cite{S2025IPFB}.%
}%
}%
%
%
