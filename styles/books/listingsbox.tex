...
\lstinputlisting[label={exec:#8},style=\@@@@gitOutputFmt,caption={The \gls{stdout} resulting from the \sql\ statements in~\href{\gitUrl{lst:#8}}{\textil{#3}} given in~\cref{lst:#8}.}]{\gitExec{exec:#8}}%
\end{figure}%
}%
%
%
