...
%
%% a four-bar button
\protected\gdef\fourBarButton{\ensuremath{\mathrel{\rlap{\raisebox{\fontdimen22\textfont2}{\ensuremath{=}}}\raisebox{-0.5\fontdimen22\textfont2}{\ensuremath{=}}}}}%
%% a three-bar button
\protected\gdef\threeBarButton{\ensuremath{\boldsymbol{\equiv}}}%
%
%% The PyCharm main menu key
\global\let\pycharmMainMenu\fourBarButton%
\global\let\pgmodelerMainMenu\threeBarButton%
...
%
% The PgModeler Add Item Icon
\protected\gdef\pgmodelerAddItem{\@key@icon@button{pgmodelerAddItem}}%
% The PgModeler "Toggle Compact Mode" button
\protected\gdef\pgmodelerToggleCompact{\@key@icon@button{pgmodelerToggleCompact}}%
%
%% The four different Crow's Foot end notations.
\protected\gdef\crowsFootOptionalOne{%
\raisebox{-0.111111em}{\includegraphics[height=0.93em,keepaspectratio]{\bookbaseDir/graphics/icons/crowsFootOptionalOne}}}%
\protected\gdef\crowsFootMandatoryOne{%
\raisebox{-0.111111em}{\includegraphics[height=0.93em,keepaspectratio]{\bookbaseDir/graphics/icons/crowsFootMandatoryOne}}}%
\protected\gdef\crowsFootOptionalMany{%
\raisebox{-0.111111em}{\includegraphics[height=0.93em,keepaspectratio]{\bookbaseDir/graphics/icons/crowsFootOptionalMany}}}%
\protected\gdef\crowsFootMandatoryMany{%
\raisebox{-0.111111em}{\includegraphics[height=0.93em,keepaspectratio]{\bookbaseDir/graphics/icons/crowsFootMandatoryMany}}}%
%
...
\gdef\crowsFoot#1#2#3#4{%
\texorpdfstring{\@crowsFoot{#1}{#2}{#3}{#4}}{#1~--~#3}%
}%
%
