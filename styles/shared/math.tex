...
%
%
%% Needed for ThisStyle and SavedStyle
\RequirePackage{scalerel}%
%
%% Remove top spacing of a math command
%% #1 the mathematical expression
\protected\gdef\mathNoTopSpacing#1{\ThisStyle{\raisebox{\dimexpr\arraystretch\ht\strutbox-\height\relax}{\ensuremath{\SavedStyle{#1}}}}}%
%
