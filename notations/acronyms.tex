...
\newacronym[description={database management system, see \gls{dbms}}]{DBMS}{DBMS}{database management system}%
\newacronym[description={database system = \acrshort{DB}~+~\acrshort{DBMS}, see \gls{dbs}}]{DBS}{DBS}{database system}%
...
\newacronym[description={JavaScript Object Notation, see \gls{json} and~\cite{E2017SE4TJDIS}},sort={JSON}]{JSON}{\gls{json}}{JavaScript Object Notation}%
...
\newacronym[description={Structured Query Language, see \cite{C20245YOQ}}]{SQL}{SQL}{Structured Query Language}%
...
\newacronym[description={\acrshort{UCS}~Transformation Format~8, see \gls{utf8} and~\cite{Y2022PPADT,ISOIEC106462020ITUCCSU}},sort={UTF-8}]{UTF8}{\gls{utf8}}{\acrshort{UCS}~Transformation Format~8}%
\newacronym[description={Version Control Systems, see \gls{vcs}}]{VCS}{\gls{vcs}}{Version Control Systems}%
\newacronym[description={Extensible Markup Language, see \gls{xml} and~\cite{BPSMM2008EMLX1FE,K2019ITXJY,CH2013XFCAMLTMC}},sort={XML}]{XML}{\gls{xml}}{Extensible Markup Language}%
\newacronym[description={{YAML}~Ain't Markup Language\texttrademark, see \gls{yaml} and~\cite{DNMAASBE2021YAMLYV1,K2019ITXJY,CGTYB2022YFFDCAIE}},sort={YAML}]{YAML}{\gls{yaml}}{{YAML}~Ain't Markup Language\texttrademark}%
%
