...
%
%
\newglossaryentry{SATLIB}{%
name={SATLIB},%
plural={SATLIB},%
description={%
is a library of benchmark instances for the \glsFull{optMaxSAT} available at \url{https://www.cs.ubc.ca/~hoos/SATLIB/index-ubc.html}~\cite{HS2000SAORFROS}.}%
}%
%
%
