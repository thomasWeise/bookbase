...
description={%
is a \pglspl{dbms} that can work on \pglspl{db} stored in single, stand-alone files but also connect to other popular \pglspl{rdb}~\cite{SSI2023MA2BTA,B2020HOMA2,UC2021AFD}. %
...
sort={PgModeler},%
description={%
the \postgresql\ \db\ modeler is a tool that allows for graphical modeling of logical schemata for \pglspl{db} using an \pglspl{ERD}-like notation. %
