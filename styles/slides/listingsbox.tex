...
\gitCode{#1}{style=python_style}{#2}{#3}{python3 -m texgit.formatters.python #4}{#5}{#6}{#7}{#8}%
}%
%
%
%% Use texgit to place a listing and its output.
%% #1 the visibility
%% #2 the git repository
%% #3 the directory
%% #4 the local path
...
\gitLoad{lst:#2:#3:#4}{#2}{#3/#4}{python3 -m texgit.formatters.python #5}%
