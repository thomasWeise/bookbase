...
plural={SATLIB},%
description={%
is a library of benchmark instances for the \glsFull{MaxSAT} available at \url{https://www.cs.ubc.ca/~hoos/SATLIB/index-ubc.html}~\cite{HS2000SAORFROS}.}%
}%
%
%
...
plural={TSPLib},%
description={%
is a library of benchmark instances for the \glsFull{TSP} available at \url{http://comopt.ifi.uni-heidelberg.de/software/TSPLIB95}~\cite{R2016T,R1991ATSPL}.}%
}%
%
%
