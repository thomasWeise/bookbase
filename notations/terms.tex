...
The \pgls{locale} then determines a set of country- or culture-dependent settings, such as the text represention for money or dates, or what decimal separators are used.%
}%
}%
%
%
