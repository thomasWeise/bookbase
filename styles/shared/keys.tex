...
\protected\gdef\pycharmConsole{\raisebox{-1.75pt}{\includegraphics[width=1em,keepaspectratio]{\bookbaseDir/graphics/icons/pycharmPythonConsole}}}%
%% The pycharm debugger resume command
\protected\gdef\pycharmDebuggerResume{\raisebox{-1.75pt}{\includegraphics[width=1em,keepaspectratio]{\bookbaseDir/graphics/icons/pycharmDebuggerResumeProgram}}}%
%% The pycharm debugger step over command
\protected\gdef\pycharmDebuggerStepOver{\raisebox{-1.75pt}{\includegraphics[width=1em,keepaspectratio]{\bookbaseDir/graphics/icons/pycharmDebuggerStepOver}}}%
%
