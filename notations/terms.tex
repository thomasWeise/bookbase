...
sort={metaheuristic},%
description={%
A \emph{metaheuristic} is an optimization algorithm which performs a cycle of trial and error during which candidate solutions are sampled from the solution space~\solutionSpace\ and evaluated using an objective function~$\objFun:\solutionSpace\mapsto\realNumbers$. %
