...
description={%
is free and open source spread sheet software~\cite{S2022L7PFEUU,DF2024LTDF}, i.e., an alternative to Microsoft \pgls{excel}. %
...
text={\softwareStyle{Excel}},%
name={excel},%
sort={excel},%
description={%
Microsoft Excel is a spreadsheet program that allows users to store, organize, manipulate, and calculate data in tabular structures~\cite{B2023DMWME,G2024ECRFMME,LF2022MOSBSO2AM3}. %
A free alternative to this commercial software is \gls{libreofficeCalc}~\cite{S2022L7PFEUU,DF2024LTDF}.%
}%
}%
%
%
