...
name={SQLite},%
sort={SQLite},%
description={is an relational \pgls{dbms} which runs as in-process library as opposed to the client-server model used by other common \pglspl{dbms}. %
It is the most wide-spread \pgls{SQL}-\pgls{db} in use today, installed in nearly every smartphone, computer, web browser, television, and automobile~\cite{WB2019RHSOOS,GPBHKP2022SPPAF,C20245YOQ}. %
