...
name={doctest},%
description={%
\emph{doctests} are small pieces of code in the \glspl{docstring} that look like interactive \python\ sessions.
...
name={GitHub},%
description={%
GitHub is a website where software projects can be hosted and managed via the \gls{git} \gls{vcs}~\cite{PRGWSUdVLFTEKPKFBV2016TSRFTAOGAG,T2024BGAGVCPMATFTND}. %
