...
sort={Android},%
description={%
Android is a common operating system for mobile phones~\cite{SGMS2022APTBNRG}.%
}%
}%
...
sort={iOS},%
description={%
iOS is the operating system that powers Apple iPhones~\cite{S2025MAPAMAIE2,C2024TCOI1AI1}. %
...
sort={iPadOS},%
description={%
iPadOS is the operating system that powers Apple iPads~\cite{C2024TCOI1AI1}. %
...
sort={LibreOffice},%
description={%
LibreOffice is on open source office suite~\cite{DF2024LTDF,GL2012LTSOOSSCBAFACSOL,S2022L7PFEUU} which is a good and free alternative to \microsoftOffice. %
...
sort={macOS},%
description={%
macOS or Mac~OS is the operating system that powers Apple Mac(intosh) computers~\cite{S2025MAPAMAIE2}. %
...
description={%
is a \pglspl{dbms} that can work on \dbs\ stored in single, stand-alone files but also connect to other popular \pglspl{rdb}~\cite{SSI2023MA2BTA,B2020HOMA2,UC2021AFD}. %
...
description={%
Microsoft~\softwareStyle{Windows} is a commercial proprietary operating system~\cite{B2023W1IO}. %
...
description={%
is a commercial suite of office software, including \microsoftExcel\ and \microsoftAccess~\cite{LF2022MOSBSO2AM3}. %
