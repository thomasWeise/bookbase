...
%% #7 the goal width
%% #8 the goal height
\protected\gdef\listingPythonAndOutput#1#2#3#4#5#6#7#8{%
\edef\@ldb@outputFmt{#3}%
\ifx\@ldb@outputFmt\empty\expandafter\@firstoftwo\else\expandafter\@secondoftwo\fi%
{\listingDoubleBox{#1}{#2}{,style=python_style}{,style=text_style}{\listingSepPython{#4}}{#5}{#6}{#7}{#8}}%
{\listingDoubleBox{#1}{#2}{,style=python_style}{#3}{\listingSepPython{#4}}{#5}{#6}{#7}{#8}}%
}%
%
