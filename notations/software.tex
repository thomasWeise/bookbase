...
sort={PgModeler},%
description={%
the \postgresql\ \db\ modeler is a tool that allows for graphical modeling of logical schemata for \pglspl{db} using an \pgls{ERD}-like notation~\cite{AES2006PPDM}. %
