...
\ifx\@ldb@outputFmt\empty\relax\edef\@ldb@outputFmt{,style=text_style}\fi%
\lstinputlisting[label={lst:#1}#4,caption={#2}]{\gitFile{lst:#1}}%
#6%
\expandafter\lstinputlisting[label={exec:#1}\@ldb@outputFmt,caption={#3}]{\gitFile{exec:#1}}%
\end{figure}%
}%
%
%
...
\listingDoubleBox{#1}{%
#3~(stored in file~\href{\gitUrl{lst:#1}}{\textil{#2}}; output in~\cref{exec:#1})%
}{%
The \pgls{stdout} of the program~\href{\gitUrl{lst:#1}}{\textil{#2}} given in~\cref{lst:#1}.%
}{,style=python_style}{#4}{%
\listingSepPython{#2}%
}%
}%
%
...
}{,style=python_style}{,style=text_style}{%
\listingSepPython{#2}%
}%
}%
%
