...
Another typical example is the structure of \pgls{db} software, where a central \pgls{server}, the \glslink{dbms}, offers access to the \pgls{db} to the different \pglspl{client}. %
Here, the \pgls{client} can be some \pgls{terminal} software shipping with the \glslink{dbms}, such as \psql, or the different applications that access the \pglspl{db}.%
}%
}%
%
%
