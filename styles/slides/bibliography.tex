...
%
% We make the superscript citations a bit smaller.
% They do not need to be big, just visible.
\renewcommand*{\mkbibsuperscript}[1]{\textsuperscript{\changeFontSizeRel{-3}{#1}}}%
%
