...
%
%% Style for Python console output
\lstdefinestyle{python_console_style}{%
style=python_style,%
literate={>>>}{{{\color{red}>}{\color{red}>}{\color{red}>}}}3 %
{...}{{\color{blue}...}}3%
}%
%
%% Style for Tool Output
...
\egroup}%
%
%% Needed for plural inline styles
...
%
%% print some sql inline
%% #1 the optional args
%% #2 the code to be printed inline
\gdef\sqlil#1{%
\inlinelistingbox{\lstinline[style=sql_style]$#1$}}%
%
...
%
%
%% print some C code inline
%% #1 the optional args
%% #2 the code to be printed inline
\gdef\cil#1{%
\inlinelistingbox{\lstinline[style=c_style]$#1$}}%
