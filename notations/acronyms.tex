...
\newacronym[description={database, see \pgls{db}}]{DB}{DB}{database}%
\newacronym[description={database management system, see \pgls{dbms}}]{DBMS}{DBMS}{database management system}%
\newacronym[description={database system = \acrshort{DB}~+~\acrshort{DBMS}, see \pgls{dbs}}]{DBS}{DBS}{database system}%
...
\newacronym[description={{YAML}~Ain't Markup Language\texttrademark, see \pgls{yaml} and~\cite{DNMAASBE2021YAMLYV1,K2019ITXJY,CGTYB2022YFFDCAIE}},sort={YAML}]{YAML}{\pgls{yaml}}{{YAML}~Ain't Markup Language\texttrademark}%
%
