...
\centering%
%
\lstinputlisting[#3]{\gitFile{lst:#2}}%
#5%
\edef\@ldb@outputFmt{#4}%
\ifx\@ldb@outputFmt\empty\expandafter\@firstoftwo\else\expandafter\@secondoftwo\fi%
{\lstinputlisting[style=text_style]{\gitFile{exec:#2}}}%
{\lstinputlisting[#4]{\gitFile{exec:#2}}}%
}{#6}{#7}{#8}{#9}%
}%
%
...
%% #5 the goal width
%% #6 the goal height
\protected\gdef\listingPythonSyntax#1#2#3#4#5#6{%
\asSyntax{%
\listingBox{#1}{lst:#2}{style=python_style,showspaces=true}{#3}{#4}{#5}{#6}%
}%
}%
%
